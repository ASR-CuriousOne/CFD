...
namespace Core{
    ...
    void Application::createImageViews(){
        ...
        for (uint32_t i = 0; i < m_swapChainImages.size(); i++) {
            m_swapChainImageViews[i] = createImageViewForImage(m_swapChainImages[i], m_swapChainImageFormat);
        }
    }

    VkImageView Application::createImageViewForImage(VkImage image, VkFormat format) {
    ...
    void Application::updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.view = glm::lookAt(glm::vec3(2.0f, 2.0f, 1.8f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f));
        ubo.proj = glm::perspective(glm::radians(27.0f), m_swapChainExtent.width / (float)m_swapChainExtent.height, 0.1f, 10.0f);
    ...
    void Application::createTextureImage(){
        ...
        stbi_uc* pixels = stbi_load("textures/checker-map_tho.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    ...
    void Application::createTextureImageView() {
        m_textureImageView = createImageViewForImage(m_textureImage, VK_FORMAT_R8G8B8A8_SRGB);
    }
